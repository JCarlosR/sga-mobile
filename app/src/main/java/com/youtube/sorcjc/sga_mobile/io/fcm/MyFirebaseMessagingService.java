package com.youtube.sorcjc.sga_mobile.io.fcm;
...
import com.youtube.sorcjc.sga_mobile.ui.LoginActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        Log.d(TAG, "Notification fired with messageBody => " + messageBody);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.unt_logo) // http://stackoverflow.com/questions/16045722/notification-not-showing
